...
class Config:
    def __init__(self):
        ...
        self.ui_scaling = 4       #4 is typical
        self.fps = 60
        ...
        self.base_ui_display_width = int(self.screen_width / self.ui_scaling)
        self.base_ui_display_height = int(self.screen_height / self.ui_scaling)
