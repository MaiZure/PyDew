...
class SpriteLoader:
    ...
    def get_large_sprite_origin(self,name):
        return self.large_sprites[name]["sprite_origin"]
        
    def get_large_sprite(self, name):
        sheet = self.large_sprites[name]["sheet"]
        sheet_tiles = self.get_spritesheet_tiles(sheet)  # OOF - this should only be used once (FIX!)
    ...
    def get_large_sprite_reverse(self, name):
